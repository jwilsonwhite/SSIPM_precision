...
runme_SSIPM.m is the driver file that calls all of the necessary files for running the rockfish and urchin fits to simulated data reported in the Yamane et al. manuscript.  It and associated files are written to allow parallel processing on a Linux cluster.
...
Post-processing and figure-generating code includes: postproc_pisco_rockfish_2.m and all of the files that start with the name analyze_*.m
